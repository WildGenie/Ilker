...
namespace PRCTicari
{
    public partial class frmDepoKarti : Form
    {
        ...
        private void frmDepoKarti_Shown(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT * FROM Depo_Tanitimi";
        ...
        private void tsbKaydet_Click(object sender, EventArgs e)
        {
            ...
            cnn.Open();
            SqlCommand cmd = cnn.CreateCommand();
            cmd.CommandText = "DELETE FROM Depo_Tanitimi";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "INSERT INTO Depo_Tanitimi (Depo_Kodu, Depo_Adi, Isyeri_Kodu) VALUES (@Depo_Kodu, @Depo_Adi, @Isyeri_Kodu)";
