...
namespace PRCTicari
{
    public partial class frmCariOzelKarti : Form
    {
        ...
        private void frmCariOzelKarti_Shown(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT * FROM Cari_Ozel_Tanitimi";
        ...
        private void tsbKaydet_Click(object sender, EventArgs e)
        {
            ...
            cnn.Open();
            SqlCommand cmd = cnn.CreateCommand();
            cmd.CommandText = "DELETE FROM Cari_Ozel_Tanitimi";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "INSERT INTO Cari_Ozel_Tanitimi (Ozel_Kodu, Ozel_Adi) VALUES (@Ozel_Kodu, @Ozel_Adi)";
