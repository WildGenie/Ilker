...
namespace PRCTicari
{
    public partial class frmCariGorevKarti : Form
    {
        ...
        private void frmCariGorevKarti_Shown(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT * FROM Cari_Gorev_Tanitimi";
        ...
        private void tsbKaydet_Click(object sender, EventArgs e)
        {
            ...
            cnn.Open();
            SqlCommand cmd = cnn.CreateCommand();
            cmd.CommandText = "DELETE FROM Cari_Gorev_Tanitimi";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "INSERT INTO Cari_Gorev_Tanitimi (Gorev_Kodu, Gorev_Adi) VALUES (@Gorev_Kodu, @Gorev_Adi)";
