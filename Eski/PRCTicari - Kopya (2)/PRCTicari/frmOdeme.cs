...
namespace PRCTicari
{
    public partial class frmOdeme : Form
    {
        ...
        public frmOdeme(DataTable dtStoklar, DataTable dtCesniler)
        {
            ...
            cmd.CommandText = "SELECT Odeme_No, Odeme_Kodu, Odeme_Adi, Odeme_Tipi, Kayit_Tipi, Kayit_Kodu, CAST(0 AS FLOAT) AS Odeme_Tutari FROM Odeme_Tanitimi WHERE Silindi = 0";
