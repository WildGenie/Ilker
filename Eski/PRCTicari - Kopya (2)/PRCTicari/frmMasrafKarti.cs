...
namespace PRCTicari
{
    public partial class frmMasrafKarti : Form
    {
        ...
        private void frmMasrafKarti_Shown(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT Masraf_Kodu, Masraf_Adi, Islem FROM Masraf_Tanitimi";
        ...
        private void tsbKaydet_Click(object sender, EventArgs e)
        {
            ...
            cnn.Open();
            SqlCommand cmd = cnn.CreateCommand();
            cmd.CommandText = "DELETE FROM Masraf_Tanitimi";
            cmd.ExecuteNonQuery();
            cmd.CommandText = "INSERT INTO Masraf_Tanitimi (Masraf_Kodu, Masraf_Adi, Islem) VALUES (@Masraf_Kodu, @Masraf_Adi, @Islem)";
