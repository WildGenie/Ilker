...
namespace PRCTicari
{
    public partial class frmStokOzelKarti : Form
    {
        ...
        private void frmStokOzelKarti_Shown(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT Ozel_Kodu, Ozel_Adi FROM Stok_Ozel_Tanitimi WHERE Kurum_Kodu = @Kurum_Kodu";
        ...
        private void tsbKaydet_Click(object sender, EventArgs e)
        {
            ...
            dgvOzeller.CurrentCell = dgvOzeller.Rows[dgvOzeller.NewRowIndex].Cells[colOzelKodu.Name];

            SqlConnection cnn = new SqlConnection(clsGenel.strConnectionString);
            cnn.Open();
            SqlCommand cmd = cnn.CreateCommand();
            cmd.CommandText = "DELETE FROM Stok_Ozel_Tanitimi WHERE Kurum_Kodu = @Kurum_Kodu";
            cmd.Parameters.AddWithValue("@Kurum_Kodu", clsGenel.strKurumKodu);
            cmd.ExecuteNonQuery();
            cmd.Parameters.Clear();
            cmd.CommandText = "INSERT INTO Stok_Ozel_Tanitimi (Kurum_Kodu, Ozel_Kodu, Ozel_Adi) VALUES (@Kurum_Kodu, @Ozel_Kodu, @Ozel_Adi)";
