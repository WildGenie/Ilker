...
namespace PRCTicari
{
    public partial class frmBelgeTipiKarti : Form
    {
        ...
        private void frmBelgeTipiKarti_Shown(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT Belge_Tipi FROM Belge_Tipi_Tanitimi WHERE Kurum_Kodu = @Kurum_Kodu";
        ...
        private void tsbKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (dgvBelgeTipleri.Rows.Count > 0)
                dgvBelgeTipleri.CurrentCell = dgvBelgeTipleri.Rows[0].Cells[colBelgeTipi.Name];
            dtBelgeTipleri.AcceptChanges();
