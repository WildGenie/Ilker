...
namespace PRCTicari
{
    public partial class frmPersonelGorevKarti : Form
    {
        ...
        private void frmCariGorevKarti_Shown(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT Gorev_Kodu, Gorev_Adi FROM Cari_Gorev_Tanitimi WHERE Kurum_Kodu = @Kurum_Kodu";
        ...
        private void tsbKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (dgvGorevler.Rows.Count > 0)
                dgvGorevler.CurrentCell = dgvGorevler.Rows[0].Cells[colGorevKodu.Name];
            dtGorevler.AcceptChanges();
