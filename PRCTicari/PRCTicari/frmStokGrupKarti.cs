...
namespace PRCTicari
{
    public partial class frmStokGrupKarti : Form
    {
        ...
        private void frmStokGrupKarti_Shown(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "SELECT Grup_Kodu, Grup_Adi FROM Stok_Grup_Tanitimi WHERE Kurum_Kodu = @Kurum_Kodu";
        ...
        private void tsbKaydet_Click(object sender, EventArgs e)
        {
            ...
            dgvGruplar.CurrentCell = dgvGruplar.Rows[dgvGruplar.NewRowIndex].Cells[colGrupKodu.Name];
            ...
            cmd.CommandText = "INSERT INTO Stok_Grup_Tanitimi (Kurum_Kodu, Grup_Kodu, Grup_Adi) VALUES (@Kurum_Kodu, @Grup_Kodu, @Grup_Adi)";
