...
namespace PRCTicari
{
    public partial class frmCariIslem : Form
    {
            ...
            if (e.KeyCode == Keys.Return)
            {
                if (cbIsyeriKodu.SelectedItemForCode().TOINT() != 0)
                {
                    if (txtFisNo.Text.Trim().TOINT() != 0)
                    {
                        ...
                        cmd.CommandText = "SELECT ID.Cari_No, CT.Cari_Kodu, '...' AS Sec_Cari_Kodu, CT.Unvani, ID.Masraf_No, MT.Masraf_Kodu, '...' AS Sec_Masraf_Kodu, MT.Masraf_Adi, ID.Alacak_Tutari, ID.Borc_Tutari, ID.Aciklama " +
        ...
        private bool fncKaydet()
        {
            ...
            dgvKalemler.CurrentCell = dgvKalemler.Rows[dgvKalemler.NewRowIndex].Cells[colCariKodu.Name];
